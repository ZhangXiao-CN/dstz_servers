...
module.exports = async (req, res) => {
	...
	// 将用户信息存储在session中
	req.session.userInfo = _.pick(user, ['nickName', 'email', 'role', 'avatar', '_id', 'status', 'createTime', 'gender', 'site', 'autograph', 'attention', 'fans', 'Favorites', 'thumb'])
	// 响应
	res.send(_.pick(user, ['nickName', 'email', 'role', 'avatar', '_id', 'status', 'createTime', 'gender', 'site', 'autograph', 'attention', 'fans', 'Favorites', 'thumb']))
}
